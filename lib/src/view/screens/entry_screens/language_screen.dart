...
class LanguageScreen extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: _buildCustomLanguageButtonArabic(languageController),
                ),
                const SizedBox(height: 20.0),
                Container(
                  margin: const EdgeInsets.symmetric(horizontal: 16.0),
                  child: __buildCustomLanguageButtonEnglish(languageController),
                ),
              ],
            ),
          ),
  ...
  Widget _buildCustomLanguageButtonArabic(
      LanguageController languageController) {
    return CustomLanguageButton(
  ...
  Widget __buildCustomLanguageButtonEnglish(
      LanguageController languageController) {
    return CustomLanguageButton(
